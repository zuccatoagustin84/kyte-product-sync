/**
 * Catalog HTML generator — TypeScript port of generate_catalog.py + catalog_template.html
 */
import type { KyteProduct } from "./kyte";
import { buildImageUrl } from "./kyte";
